...
public class Person {
	//접근제어자(지정자)의 종류
	private int weight;//외부에 공유 안된다 사용시 getter/setter(메서드)을 사용해 주어야 한다
...
//	}
	//alt+shift+s getorset누르면 자동 생성 가능
	public int getWeight() {//get은 불러 오는 거기 때문에 굳이 매개변수를 쓰지 않는다
